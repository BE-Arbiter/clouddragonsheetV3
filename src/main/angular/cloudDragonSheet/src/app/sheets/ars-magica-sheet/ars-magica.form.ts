...
import {AM5CharacteristicForm, AM5Characteristics, AM5CharacteristicsForm} from "./model/AM5-characteristics.model";
import {AM5GeneralData, AM5GeneralDataForm} from "./model/AM5-general.model";
import {AM5VirtueForm} from "./model/AM5-virtue.model";
import {AM5Configuration} from "./model/AM5-configuration.model";
import {AM5Ability, AM5AbilityForm} from "./model/AM5-ability.model";
...
export class ArsMagicaFormManager implements OnInit {
  ...
  //Public Methods
  public getformGroup(username:string): FormGroup<ArsMagicaFormGroup> {
